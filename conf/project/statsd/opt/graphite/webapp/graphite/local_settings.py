...
#
# Additional customizations to Django settings can be added to this file as
# well
...
# unneeded cache misses. Set to [] to disable caching of images and fetched
# data
...
## Data directories
# NOTE: If any directory is unreadable in STANDARD_DIRS it will break metric
# browsing
...
# instances to use the same database. Note that this database is only used to
# store
...
# relay using
# consistent hashing), you'll need to list the ip address, cache query port,
# and instance name of each carbon-cache
# instance on the local machine (NOT every carbon-cache in the entire cluster).
# The default cache query port is 7002
